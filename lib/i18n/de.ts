...
export const de = {
  ...
  aiTagging: {
    ...
    sourceWikidata: "Quelle: Wikidata",
    sourceLibrary: "Quelle: andere Bücher der Bibliothek",
    sourceAi: "Quelle: KI-Vorschlag",
    toastNoSuggestions: "Keine Vorschläge verfügbar",
    toastNoNewTags: "Keine neuen Schlagwörter vorgeschlagen",
    toastTagAddedOne: "{count} Schlagwort hinzugefügt",
    toastTagsAddedMany: "{count} Schlagwörter hinzugefügt",
    toastSuggestError: "Fehler beim Erstellen der Vorschläge",
    batchTagAll: "Alle taggen",
    batchTagging: "Tagge…",
  ...
  healthPage: {
    ...
    detailKey: {
      ...
      apiKeys: "API-Keys",
      activeAiProvider: "Aktiver KI-Anbieter",
      pinnedAiProvider: "Festgelegter KI-Anbieter",
    },
    footer: {
      jsonApi: "JSON-API",
    },
