...
export const de = {
  ...
  bookEditForm: {
    ...
    toastTitleRequired: "Bitte geben Sie einen Titel ein.",
    toastAuthorRequired: "Bitte geben Sie einen Autor ein.",
    toastCreateError: "Fehler beim Erstellen: {{status}} {{statusText}}",
    toastNoBookIdInResponse: "Keine Buch-ID in der Antwort erhalten",
    toastCoverUploadFailed:
      "Buch erstellt, aber Cover konnte nicht hochgeladen werden.",
    toastWithCoverSuffix: " (mit Cover)",
    toastBookCreated: 'Buch "{{title}}" erfolgreich erstellt{{coverInfo}}!',
    toastSaveError: "Fehler beim Speichern des Buches",
    toastBookSaved: 'Buch "{{title}}" gespeichert, gut gemacht!',
