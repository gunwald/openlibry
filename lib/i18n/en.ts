...
export const en: Dictionary = {
  ...
  bookEditForm: {
    ...
    toastAuthorRequired: "Please enter an author.",
    toastCreateError: "Error creating book: {{status}} {{statusText}}",
    toastNoBookIdInResponse: "No book ID received in response",
    toastCoverUploadFailed:
      "Book created, but the cover could not be uploaded.",
    toastWithCoverSuffix: " (with cover)",
    toastBookCreated: 'Book "{{title}}" created successfully{{coverInfo}}!',
    toastSaveError: "Error saving the book",
    toastBookSaved: 'Book "{{title}}" saved, well done!',
    toastBookDeleted: "Book deleted",
    toastDeleteError: "Error deleting the book",
