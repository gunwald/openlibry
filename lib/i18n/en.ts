...
export const en: Dictionary = {
  ...
  holdButton: {
    deleteLabel: "Delete",
    tooltip: "Press and hold to confirm",
  },
  nav: {
    rental: {
      title: "Lending",
  ...
  aiTagging: {
    ...
    suggest: "Suggest",
    chipNewTitle: "New tag (not yet in the library)",
    chipOffStyleTitle:
      "New tag that may not fit the library's style — please review",
    chipExistingTitle: "Existing tag",
    sourceDnb: "Source: German National Library",
    sourceOpenlibrary: "Source: Open Library",
    sourceWikidata: "Source: Wikidata",
    sourceLibrary: "Source: other books in the library",
    sourceAi: "Source: AI suggestion",
    toastNoSuggestions: "No suggestions available",
    toastNoNewTags: "No new tags suggested",
    toastTagAddedOne: "{count} tag added",
    toastTagsAddedMany: "{count} tags added",
    toastSuggestError: "Error generating suggestions",
    batchTagAll: "Tag all",
    batchTagging: "Tagging…",
  ...
  healthPage: {
    ...
    detailKey: {
      ...
      pinnedAiProvider: "Pinned AI provider",
    },
    footer: {
      jsonApi: "JSON API",
    },
  ...
  accounts: {
    pageTitle: "Admin Accounts – OpenLibry",
    heading: "Admin Accounts",
    subtitle: "Manage the login accounts for OpenLibry.",
    existingAccounts: "Existing Accounts",
    newAccountSection: "Create New Account",
    backToAdmin: "← Back to Admin Area",
    loading: "Loading accounts…",
    loadError: "Error loading accounts.",
    lastAccountWarning:
      "The last account cannot be deleted. Please create another account first.",
    selfBadge: "You",
    deleteTitle: "Delete account",
    editTitle: "Edit",
    confirmDeleteQuestion: "Really delete?",
    confirmDeleteYes: "Yes",
    confirmDeleteNo: "No",
    toastDeleted: "Account {username} deleted.",
    toastDeleteError: "Error deleting account",
    toastUpdated: "Account {username} updated.",
    toastCreated: "New account successfully created.",
    editForm: {
      labelUsername: "Username",
      labelEmail: "E-Mail",
      ...
      passwordTooShort: "Minimum 3 characters required",
      passwordMismatch: "Passwords do not match",
      cancel: "Cancel",
      save: "Save",
    },
    createForm: {
      toggleButton: "Create New Admin Account",
      heading: "New Account",
      labelUsername: "Username",
      labelEmail: "E-Mail",
      labelPassword: "Password",
      labelPasswordConfirm: "Confirm Password",
      passwordTooShort: "Minimum 3 characters",
      passwordMismatch: "Passwords do not match",
      cancel: "Cancel",
