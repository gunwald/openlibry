...
export const es: Dictionary = {
  ...
  bookEditForm: {
    ...
    toastAuthorRequired: "Por favor, introduce un autor.",
    toastCreateError: "Error al crear: {{status}} {{statusText}}",
    toastNoBookIdInResponse: "No se recibió ningún ID de libro en la respuesta",
    toastCoverUploadFailed: "Libro creado, pero no se pudo subir la portada.",
    toastWithCoverSuffix: " (con portada)",
    toastBookCreated: '¡Libro "{{title}}" creado correctamente{{coverInfo}}!',
    toastSaveError: "Error al guardar el libro",
    toastBookSaved: '¡Libro "{{title}}" guardado, muy bien!',
  ...
  bookPage: {
    ...
    toastBookDataCopied:
      "Datos copiados del libro original — revísalos y guarda",
