...
export const es: Dictionary = {
  ...
  aiTagging: {
    ...
    sourceWikidata: "Fuente: Wikidata",
    sourceLibrary: "Fuente: otros libros de la biblioteca",
    sourceAi: "Fuente: sugerencia de IA",
    toastNoSuggestions: "No hay sugerencias disponibles",
    toastNoNewTags: "No se sugirieron etiquetas nuevas",
    toastTagAddedOne: "{count} etiqueta añadida",
    toastTagsAddedMany: "{count} etiquetas añadidas",
    toastSuggestError: "Error al generar sugerencias",
    batchTagAll: "Etiquetar todo",
    batchTagging: "Etiquetando…",
    batchNoTaggable: "No hay entradas con título para etiquetar",
    batchTaggedSummary: "{count} entradas etiquetadas",
    batchTaggedSummaryNew: "{count} entradas etiquetadas ({newCount} etiquetas nuevas)",
    batchTaggedPartial: "{count} entradas etiquetadas, {failed} no funcionaron",
    batchTagFailed: "No se pudieron obtener sugerencias para {count} entradas",
  },
  bookSelect: {
  ...
  healthPage: {
    ...
    detailKey: {
      ...
      apiKeys: "Claves API",
      activeAiProvider: "Proveedor de IA activo",
      pinnedAiProvider: "Proveedor de IA fijado",
    },
    footer: {
      jsonApi: "API JSON",
    },
